              ...
              (else
                  (let ((t1 (first-term L1)) (t2 (first-term L2)))
                       (cond ((> (order t1) (order t2))
                             ...
                             ((< (order t1) (order t2))
                              (adjoin-term
                                  (convert-sign t2) (sub-terms L1 (rest-terms L2))))
                             (else
                              (adjoin-term
                                  (make-term (order t1)
...
(define p1 (make-polynomial 'x (list (make-term 2 4) (make-term 0 1))))
(define p2 (make-polynomial 'x (list (make-term 2 3) (make-term 0 1))))
(define zero-poly (make-polynomial 'x (list (make-term 2 0) (make-term 0 0))))
