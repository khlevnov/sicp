...
(define (sum3 x y z) (apply-generic 'sum3 x y z))
(define (sum4 x y z t) (apply-generic 'sum4 x y z t))
                     ...
                     (let ((type1 (car type-tags))
                          ...
                          (let ((t1->t2 (get-coercion type1 type2))
                               ...
                               (cond (t1->t2 (apply-generic op (t1->t2 a1) a2))
                                     ...
                                     (else (error "Нет метода после преобразований" (list op type-tags))))))
                     (error "Нет метода в таблице" (list op type-tags)))))))
...
(exp (make-complex-from-real-imag 4 0) (make-complex-from-real-imag 3 0))
