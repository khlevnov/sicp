    ...
    (define (adjoin-term term-list)
        (lambda (term)
            (if (= (order term) (length term-list))
                ...
                ((adjoin-term (cons 0 term-list)) term))))
...
(define sparse2 (make-sparse-polynomial 'x (list '(1 2) '(-1 0))))
(define dense1 (make-dense-polynomial 'x (list 1 0 0 0 0 -1)))
(define dense2 (make-dense-polynomial 'x (list 1 0 -1)))
(div sparse1 sparse2)
